...
test_df = pd.read_csv('/kaggle/input/slideandseekclasificationlandslidedetectiondataset/Test.csv')
fold_preds = []
for fold in range(5):
    preds = np.load(f'eva_setup/models_folds/test_preds_fold{fold}.npy')
