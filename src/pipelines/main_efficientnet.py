...
from src.models.train_efficientnet import train_efficientnet, infer_efficientnet
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_path", type=str, default="output/efficientnet_submission_probs.csv")
